...
/**
* Get favorite tracks.
* @param {{limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.getMyTracks = function (query, callback) {
  var self = this;
  self._baseRequest('/users/' + _userID + '/favorites/tracks', {
      limit: query.limit || 999,
      filter: query.filter || 'ALL',
      offset: query.offset || 0,
      countryCode: _countryCode
...
* @param {{limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.getMyAlbums = function (query, callback){
  var self = this;
  self._baseRequest('/users/'+ _userID + '/favorites/albums', {
      limit: query.limit || 999,
      filter: query.filter || 'ALL',
      offset: query.offset || 0,
      countryCode: _countryCode
...
* @param {{limit: Number, filter: String, offset: Number}}
*/
TidalAPI.prototype.getMyPlaylists = function (query, callback){
  var self = this;
  self._baseRequest('/users/'+ _userID + '/favorites/playlists', {
      limit: query.limit || 999,
      filter: query.filter || 'ALL',
      offset: query.offset || 0,
      countryCode: _countryCode
